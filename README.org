...
EDIT: 2022-06-21: now that we have implemented the workflow on a VM with the GEO-ICT, we started working in the ~_targets.R~ and ~functions.R~ files directly.
