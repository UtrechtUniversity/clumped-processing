...
** upload results
- ~out/motu_all_data_RAW.csv~ to OneDrive
- ~out/motu_cycle_level_summaries.rds~ to OneDrive
* visualise progress
This function shows a tree of all the targets and their relationships in an interactive graph in the browser. It's a bit too large to be useful here.
#+begin_src R :file imgs/targets_progress.png :results output graphics file
...
[[file:~/Pictures/Screenshots/2021-09-15-13:52:42_region.png]]

* debug
** debug a specific step
set the ~error = "workspace~ option in [[*libraries/packages][libraries/packages]]
...
: [1] "motu_file_info_46de0da2"       "motu_raw_deltas_2db206f0"
: [3] "ness_scn_meta_export"          "pacman_file_info_raw_8284cc8f"
#+begin_src R
  ## tar_workspace(motu_raw_deltas_0edd0341)  # this one was not working earlier due to duplicated cycles (likely duplicated files?). Fixed by adding a distinct call in there
  ## tar_workspace(motu_sample_level)  # this one was struggling due to param_49 not being in the cycle data
  ## tar_workspace(motu_file_info_46de0da2)  # this one was struggling due to param_49 not being in the cycle data
  ## tar_workspace(motu_sample_level) # this one fails with "selections can't have missing values"
  ## tar_workspace(motu_file_info_46de0da2) # don't know why I had left this one debugging, s44_init?
  ## tar_workspace(pacman_file_info_raw_8284cc8f) # this one didn't have column measurement_info
#+end_src

#+RESULTS:

** DONE issue with overwriting the ~comment~ field:
CLOSED: [2021-02-11 Thu 16:59]
*** issue identification
RV's comments are wrong: there is no ~Comment_overwrite~ specified, yet they have been assigned a ~comment~ of ~STD~ in stead of their original ~Comment~ value (i.e. ~RV~).
#+begin_src R :results value :colnames yes
  tar_read(motu_temperature) |>
    filter(Analysis %in% 2717L:2740L) |>
    select(Analysis, file_id, Comment, Comment_overwrite, comment,
           `Identifier 1`, `Identifier 1_overwrite`, identifier_1,
           `Identifier 2`, `Identifier 2_overwrite`, identifier_2) |>
    print(width = Inf)
#+end_src

#+RESULTS:

| Analysis | file_id                         | Comment | Comment_overwrite | comment | Identifier 1 | Identifier 1_overwrite | identifier_1 | Identifier 2 | Identifier 2_overwrite | identifier_2         |
|----------+---------------------------------+---------+-------------------+---------+--------------+------------------------+--------------+--------------+------------------------+----------------------|
|     2717 | 180413_13_RobinV_9_RV239+A.did  | RV      | nil               | RV      | RV239+A      | nil                    | RV239+A      | nil          | walvis ridge dst 100   | walvis ridge dst 100 |
|     2718 | 180413_13_RobinV_10_RV239+B.did | RV      | nil               | RV      | RV239+B      | nil                    | RV239+B      | nil          | walvis ridge dst 100   | walvis ridge dst 100 |
|     2719 | 180413_13_RobinV_11_RV239+C.did | RV      | nil               | RV      | RV239+C      | nil                    | RV239+C      | nil          | walvis ridge dst 100   | walvis ridge dst 100 |
|     2720 | 180413_13_RobinV_12_RV223+A.did | RV      | nil               | RV      | RV223+A      | nil                    | RV223+A      | nil          | walvis ridge dst 100   | walvis ridge dst 100 |
|     2721 | 180413_13_RobinV_13_ETH-1.did   | STD     | nil               | STD     | ETH-1        | nil                    | ETH-1        | nil          | nil                    | nil                  |
|     2722 | 180413_13_RobinV_14_ETH-1.did   | STD     | nil               | STD     | ETH-1        | nil                    | ETH-1        | nil          | nil                    | nil                  |
|     2723 | 180414_13_RobinV_15_RV223+B.did | RV      | nil               | RV      | RV223+B      | nil                    | RV223+B      | nil          | walvis ridge dst 100   | walvis ridge dst 100 |
|     2724 | 180414_13_RobinV_16_RV223+C.did | RV      | nil               | RV      | RV223+C      | nil                    | RV223+C      | nil          | walvis ridge dst 100   | walvis ridge dst 100 |
|     2725 | 180414_13_RobinV_17_RV223+D.did | RV      | nil               | RV      | RV223+D      | nil                    | RV223+D      | nil          | walvis ridge dst 100   | walvis ridge dst 100 |
|     2726 | 180414_13_RobinV_18_RV247.did   | RV      | nil               | RV      | RV247        | nil                    | RV247        | nil          | walvis ridge dst 100   | walvis ridge dst 100 |
|     2727 | 180414_13_RobinV_19_ETH-3.did   | STD     | nil               | STD     | ETH-3        | nil                    | ETH-3        | nil          | nil                    | nil                  |
|     2728 | 180414_13_RobinV_20_ETH-3.did   | STD     | nil               | STD     | ETH-3        | nil                    | ETH-3        | nil          | nil                    | nil                  |
|     2729 | 180414_13_RobinV_21_RV207+A.did | RV      | nil               | RV      | RV207+A      | nil                    | RV207+A      | nil          | walvis ridge dst 100   | walvis ridge dst 100 |
|     2730 | 180414_13_RobinV_22_RV207+B.did | RV      | nil               | RV      | RV207+B      | nil                    | RV207+B      | nil          | walvis ridge dst 100   | walvis ridge dst 100 |
|     2731 | 180414_13_RobinV_23_RV232+A.did | RV      | nil               | RV      | RV232+A      | nil                    | RV232+A      | nil          | walvis ridge dst 100   | walvis ridge dst 100 |
|     2732 | 180414_13_RobinV_24_RV232+B.did | RV      | nil               | RV      | RV232+B      | nil                    | RV232+B      | nil          | walvis ridge dst 100   | walvis ridge dst 100 |
|     2733 | 180414_13_RobinV_25_ETH-2.did   | STD     | nil               | STD     | ETH-2        | nil                    | ETH-2        | nil          | nil                    | nil                  |
|     2734 | 180414_13_RobinV_26_ETH-2.did   | STD     | nil               | STD     | ETH-2        | nil                    | ETH-2        | nil          | nil                    | nil                  |
|     2735 | 180414_13_RobinV_27_RV232+C.did | RV      | nil               | RV      | RV232+C      | nil                    | RV232+C      | nil          | walvis ridge dst 100   | walvis ridge dst 100 |
|     2736 | 180414_13_RobinV_28_RV215+A.did | RV      | nil               | RV      | RV215+A      | nil                    | RV215+A      | nil          | walvis ridge dst 100   | walvis ridge dst 100 |
|     2737 | 180414_13_RobinV_29_RV215+B.did | RV      | nil               | RV      | RV215+B      | nil                    | RV215+B      | nil          | walvis ridge dst 100   | walvis ridge dst 100 |
|     2738 | 180414_13_RobinV_30_RV215+C.did | RV      | nil               | RV      | RV215+C      | nil                    | RV215+C      | nil          | walvis ridge dst 100   | walvis ridge dst 100 |
|     2739 | 180414_13_RobinV_31_ETH-3.did   | STD     | nil               | STD     | ETH-3        | nil                    | ETH-3        | nil          | nil                    | nil                  |
|     2740 | 180414_13_RobinV_32_ETH-3.did   | STD     | nil               | STD     | ETH-3        | nil                    | ETH-3        | nil          | nil                    | nil                  |
*** this must happen here [[*overwrite_meta][overwrite_meta]].
*** Let's try to re-apply the function to see if there's a problem in the application or in the function itself:
#+begin_src R :results value :colnames yes
   # if motu_file_info fails, reproduce it like this:
   ## iso_get_file_info(tar_read(motu_dids)) |>
   ##                           filter_info_duplicates() |>
   ##                           parse_col_types() |>
   ##                           split_meas_info() |>
   ##                           select(-measurement_info) |> # this is a list
   ##                           add_timeofday() |>
   ##                           add_inits(tar_read(motu_dids)) |>
   ##                           clumpedr::append_ref_deltas(.did = tar_read(motu_dids)) |>
   ##                           # this adds all the _overwrite fields and manual_outlier etc.
   ##                           fix_metadata(tar_read(motu_metadata), irms = "MotU-KielIV") |>
  tar_read(motu_file_info) |>
  bind_rows() |>
  filter(Analysis %in% 2717L:2740L) |>
  ## rowwise() |>
  ## overwrite_meta(stdnames = tar_read(stdnames)) |>
  select(Analysis, ## Preparation, Preparation_overwrite, preparation,
         file_id, Comment, Comment_overwrite, comment ## `Identifier 1`, `Identifier 1_overwrite`, `Identifier 2`, `Identifier 2_overwrite`, `Weight [mg]`, `Weight [mg]_overwrite`, masspec, broadid
         ) #|>
  # below manual line does work nicely
  ## mutate(comment = ifelse(is.na(.data$Comment_overwrite), .data$Comment, .data$Comment_overwrite))
  # rewrote overwrite_meta to work like this
  # now I have issues where the columns don't exist
#+end_src

#+RESULTS:

| Analysis | file_id                         | Comment | Comment_overwrite | comment |
|----------+---------------------------------+---------+-------------------+---------|
|     2718 | 180413_13_RobinV_10_RV239+B.did | RV      | nil               | RV      |
|     2719 | 180413_13_RobinV_11_RV239+C.did | RV      | nil               | RV      |
|     2720 | 180413_13_RobinV_12_RV223+A.did | RV      | nil               | RV      |
|     2721 | 180413_13_RobinV_13_ETH-1.did   | STD     | nil               | STD     |
|     2722 | 180413_13_RobinV_14_ETH-1.did   | STD     | nil               | STD     |
|     2717 | 180413_13_RobinV_9_RV239+A.did  | RV      | nil               | RV      |
|     2723 | 180414_13_RobinV_15_RV223+B.did | RV      | nil               | RV      |
|     2724 | 180414_13_RobinV_16_RV223+C.did | RV      | nil               | RV      |
|     2725 | 180414_13_RobinV_17_RV223+D.did | RV      | nil               | RV      |
|     2726 | 180414_13_RobinV_18_RV247.did   | RV      | nil               | RV      |
|     2727 | 180414_13_RobinV_19_ETH-3.did   | STD     | nil               | STD     |
|     2728 | 180414_13_RobinV_20_ETH-3.did   | STD     | nil               | STD     |
|     2729 | 180414_13_RobinV_21_RV207+A.did | RV      | nil               | RV      |
|     2730 | 180414_13_RobinV_22_RV207+B.did | RV      | nil               | RV      |
|     2731 | 180414_13_RobinV_23_RV232+A.did | RV      | nil               | RV      |
|     2732 | 180414_13_RobinV_24_RV232+B.did | RV      | nil               | RV      |
|     2733 | 180414_13_RobinV_25_ETH-2.did   | STD     | nil               | STD     |
|     2734 | 180414_13_RobinV_26_ETH-2.did   | STD     | nil               | STD     |
|     2735 | 180414_13_RobinV_27_RV232+C.did | RV      | nil               | RV      |
|     2736 | 180414_13_RobinV_28_RV215+A.did | RV      | nil               | RV      |
|     2737 | 180414_13_RobinV_29_RV215+B.did | RV      | nil               | RV      |
|     2738 | 180414_13_RobinV_30_RV215+C.did | RV      | nil               | RV      |
|     2739 | 180414_13_RobinV_31_ETH-3.did   | STD     | nil               | STD     |
|     2740 | 180414_13_RobinV_32_ETH-3.did   | STD     | nil               | STD     |

I rewrote overwrite_meta to not check for the column names!
This gave me problems with one set where `Identifier 2` was missing
I had to use the `&&` operator to check if it exists in the colnames
This didn't fix the issue, but adding a ~rowwise()~ did somehow?

** DONE issue: s44_init and r44_init are often ~NA~
CLOSED: [2021-03-09 Tue 19:25]
:LOGBOOK:
- Note taken on [2021-03-09 Tue 19:25] \\
  issue was with the ifelse analysis line, not sure if it'll work on empty rows now
- State "DONE"       from "WAIT"       [2021-03-09 Tue 19:25]
- State "WAIT"       from              [2021-03-05 Fri 22:10]
:END:
